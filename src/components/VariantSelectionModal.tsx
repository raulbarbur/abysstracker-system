    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-card rounded-3xl shadow-2xl w-full max-w-md overflow-hidden border border-border">
        <div className="p-5 border-b border-border flex justify-between items-center bg-muted/30">
          <div>
            <h3 className="font-black text-lg text-foreground font-nunito">
              ...
              >
                <div className="z-10 relative">
                  ...
                  {hasStock ? (
                    ...
                    <span className="text-xs font-bold text-destructive uppercase bg-destructive/10 px-2 py-0.5 rounded">
                      Agotado
                    </span>
                  )}
                </div>
