...
export function Pagination({ totalPages, currentPage }: PaginationProps) {
  ...
  const commonButtonClass =
    "px-4 h-9 flex items-center justify-center rounded-lg font-bold text-xs transition border";
    ...
    <div className="flex items-center justify-between p-4 border-t border-border">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={cn(
            commonButtonClass,
            isFirstPage ? disabledClass : inactiveClass,
          )}
        >
          Anterior
        </button>
        <button
          ...
          className={cn(
            commonButtonClass,
            isLastPage ? disabledClass : inactiveClass,
          )}
        >
          Siguiente
        </button>
